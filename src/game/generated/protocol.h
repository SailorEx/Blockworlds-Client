...
enum
{
	...
	PLAYERFLAG_AIM = 1<<4,
	PLAYERFLAG_ZClient = 1<<5,
	PLAYERFLAG_ATH1 = 1<<6,
	PLAYERFLAG_ATH2 = 1<<7,
	PLAYERFLAG_EMPTY = 1<<8,
	PLAYERFLAG_EMPTY2 = 1<<9,
	PLAYERFLAG_EMPTY3 = 1<<10,
};
...
struct CNetMsg_Cl_IsDDNet
{
	int MsgID() const { return NETMSGTYPE_CL_ISDDNET; }
